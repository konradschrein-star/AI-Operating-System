...
/**
 * /settings — a REAL route, not a client-side surface toggle.
 *
 * Until 2026-08-02 "settings" was an entry in PLACEHOLDER_SURFACES inside
 * DesktopApp.tsx: a hardcoded mockup card listing three icons, reachable only
 * as tab state on the main page. Every one of the 18 surfaces lives that way,
 * which is why nothing in this app has its own URL. This is the first one
 * extracted; the rest is separate work.
 */
            ...
            {data.accounts.map((a) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    style={{ color: tokens.textSoft, fontSize: 13, marginTop: 8 }}
                  >
                    {a.health_detail}
                  </div>
