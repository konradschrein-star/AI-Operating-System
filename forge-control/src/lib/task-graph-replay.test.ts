 ...
 * (`03-quality.md` §2.1).
 *
 * The claim it exists to prove: migration `0043_task_graph.sql` turns today's
...
/**
 * The TypeScript MIRROR of `0043_task_graph.sql`'s backfill UPDATE, which is
 ...
 * `db/migrations/0043_task_graph.sql` and say in the review that it did.** If
...
interface GraphInputOptions {
  /**
   * The ids that existed AT MIGRATION TIME — the rows `0043_task_graph.sql`'s
